...
cd ../..
mkdir "09. Advanced rebase"
cd "09. Advanced rebase"
call :SetupRepos
git tag v0.0
...
cd ../..
mkdir "07. Reordering History"
cd "07. Reordering History"
call :SetupRepos
...
cd ../..
mkdir "06. Restoring Files"
cd "06. Restoring Files"
call :SetupRepos
...
cd ../..
mkdir "05. Reverted Merge"
cd "05. Reverted Merge"
call :SetupRepos
...
cd ../..
mkdir "03. Merge Conflict"
cd "03. Merge Conflict"
call :SetupRepos
